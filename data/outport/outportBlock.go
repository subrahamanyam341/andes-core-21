//go:generate protoc -I=. -I=$GOPATH/src/github.com/subrahamanyam341/andes-core-21/data/block -I=$GOPATH/src -I=$GOPATH/src/github.com/dharitri-org/protobuf/protobuf --gogoslick_out=$GOPATH/src outportBlock.proto

package outport

import (
	"github.com/subrahamanyam341/andes-core-21/data"
	"github.com/subrahamanyam341/andes-core-21/data/block"
)
