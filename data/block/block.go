//go:generate protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/dharitri-org/protobuf/protobuf  --gogoslick_out=$GOPATH/src block.proto
package block
...
import (
	...
	"github.com/subrahamanyam341/andes-core-21/data/headerVersionData"
)
